...
public class EgovImgPaginationRenderer extends AbstractPaginationRenderer {
	...
	*/
	public EgovImgPaginationRenderer() {
		...
		nextPageLabel = "<a href=\"#\" onclick=\"{0}({1}); return false;\">" + "<image src='" + strWebDir + "btn_page_next1.gif' border=0/></a>&#160;";
		lastPageLabel = "<a href=\"#\" onclick=\"{0}({1}); return false;\">" + "<image src='" + strWebDir + "btn_page_next10.gif' border=0/></a>&#160;";
	}
}
